...
/**
 * Mini parser for decrease with returned variables.
 * Example: $a = $b--
 * @author equesada
 */
public class DecreaseValueWithVariables implements RequestParser<String> {

	/**
	 * The DecreaseValue mini parser.
	 */
	private final DecreaseValue decreaseValueMiniParser;
	 ...
	 * Default constructor.
	 */
	public DecreaseValueWithVariables() {
		super();
		...
		decreaseValueMiniParser = new DecreaseValue();
	}
	...
	public final List<Request> parse(final String str) {
		...
		List<Request> ret = decreaseValueMiniParser
		    .parse(splitted[1]);
